                        ...
                        <section class="mt-8 overflow-hidden rounded-[2.25rem] bg-white shadow-[0_18px_45px_rgba(15,23,42,0.14)] ring-1 ring-slate-200">
                            ...
                            <div class="px-6 py-16 md:px-10 md:py-20">
                                <div class="mx-auto max-w-3xl text-center">
                                    ...
                                    <a href="#detail-status" class="mt-8 inline-flex rounded-full bg-blue-500 px-8 py-4 text-lg font-extrabold uppercase tracking-wide text-white shadow-[0_18px_40px_rgba(59,130,246,0.35)] transition hover:bg-blue-600">
