...
@php
    ...
    $heroSlides = [
        [
            ...
            'image' => $homeBanners->has(1) ? asset('storage/' . $homeBanners->get(1)->image_path) : asset('image/banner-ppdb-2026-2027.png'),
            'theme' => 'blue',
            'fullBanner' => true,
        ],
        [
            ...
            'image' => $homeBanners->has(2) ? asset('storage/' . $homeBanners->get(2)->image_path) : asset('image/banner-profil-sekolah.png'),
            'theme' => 'pink',
            'fullBanner' => true,
        ],
        [
            ...
            'image' => $homeBanners->has(3) ? asset('storage/' . $homeBanners->get(3)->image_path) : asset('image/banner-selamat-datang-ppdb.png'),
            'theme' => 'emerald',
            'fullBanner' => true,
        ],
    ];
