...
<body class="bg-sky-500 text-slate-900">
    <header class="sticky top-0 z-50 border-b border-sky-400/60 bg-sky-500/95 backdrop-blur">
        <div class="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
            <a href="{{ route('ppdb.info') }}" class="flex items-center gap-3">
                ...
                <div class="max-w-xs">
                    <p class="text-[10px] font-semibold uppercase tracking-[0.2em] text-sky-100 sm:text-xs">Sistem Penerimaan Murid Baru</p>
                    <h1 class="text-sm font-extrabold uppercase leading-tight text-yellow-300 sm:text-lg">Raudhatul Athfal Fadhilah</h1>
                </div>
            </a>

            <nav class="hidden items-center gap-6 text-sm font-semibold text-sky-100 md:flex">
                <a href="#persyaratan" class="transition hover:text-white">Persyaratan</a>
                <a href="#alur" class="transition hover:text-white">Alur</a>
                <a href="#hubungi-kami" class="transition hover:text-white">Hubungi Kami</a>
    ...
    <main>
        <section class="mx-auto grid max-w-7xl gap-10 px-4 pb-20 pt-10 sm:px-6 lg:grid-cols-[1.05fr_0.95fr] lg:px-8 lg:pb-24 lg:pt-14">
            ...
            <div class="flex flex-col justify-center">
                ...
                <h2 class="max-w-xl text-4xl font-extrabold leading-tight text-yellow-300 sm:text-5xl">Selamat Datang di Raudhatul Athfal Fadhilah.</h2>
                <p class="mt-5 max-w-xl text-base leading-8 text-sky-50 sm:text-lg">
        ...
        <section id="persyaratan" class="scroll-mt-28 px-4 py-16 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-5xl text-center">
                ...
                <p class="mx-auto mt-4 max-w-3xl text-sm leading-7 text-sky-100 sm:text-base">
        ...
        <section id="alur" class="scroll-mt-28 bg-sky-600/30 px-4 py-16 sm:px-6 lg:px-8">
            <div class="mx-auto max-w-5xl text-center">
        ...
        <section id="hubungi-kami" class="scroll-mt-28 bg-sky-100 px-4 py-16 sm:px-6 lg:px-8">
            <div class="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[0.9fr_1.1fr]">
                ...
                <div class="rounded-[2rem] bg-white p-8 shadow-[0_24px_50px_rgba(15,23,42,0.16)]">
                    ...
                    <div class="mt-8 flex flex-col gap-4 sm:flex-row">
                        <a href="{{ route('login') }}" class="inline-flex items-center justify-center rounded-2xl bg-blue-700 px-6 py-4 text-sm font-bold uppercase tracking-wide text-white transition hover:bg-blue-800">
                            Masuk ke Portal PPDB
                        </a>
    ...
    <footer class="bg-blue-950 px-4 py-5 text-center text-sm font-medium text-sky-100 sm:px-6 lg:px-8">
